...
const styles = StyleSheet.create({
  ...
  leftPanel: { width: 52, borderRightWidth: 1, borderRightColor: Colors.border, backgroundColor: Colors.card },
  ...
  catBtnText: { fontSize: 11, fontWeight: '600', color: Colors.text, lineHeight: 15, textAlign: 'center' },
  ...
  editIconText: { fontSize: 11, color: Colors.textSecondary },
